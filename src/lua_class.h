 ...
 *                int index(lua_State *L, lua_Integer val)
 *                int index(lua_State *L, std::string_view val)
 * __newindex : For full control:
                  int newindex(lua_State *L)
 *              Or convenience functions:
 *                int newindex(lua_State *L, lua_Integer val)
 *                int newindex(lua_State *L, std::string_view val)
...
public:
	...
	static T* from_stack(lua_State* L, int idx, bool throwError = true);
